...
<body>
    <div id="mainform">
        ...
        <div class="div-right">
            <button class="btn-back" onclick="window.location.href='../../../EventSearch/eventSearch?keyword=<?php echo $keyword;?>'">Quay lại</button>
        </div>
        <br>
        <div>
        ...
        <form id="form" method="POST" <?php echo 'action="../../addSchedule/' . $event_id . '/' . $keyword . '"'?>">
