...
<body>
    ...
    <form method="post" action="classroom_add_confirm.php" >   

        <label class="input-form" for="name">Tên sự kiện</label>
        <input id="name" type="text" name="name" maxlength="100" value="<?php echo $this->name;?>"><br>        
        
        <label class="input-form" for="slogan">Slogan</label>
        <input id="slogan" type="text" name="slogan" maxlength="250" value="<?php echo $this->slogan;?>"><br>        
       
        <label class="input-form" for="leader">Leader</label>
        <input id="leader" type="text" name="leader" maxlength="250" value="<?php echo $this->leader;?>"><br>        
       
        <label class="input-form" for="description">Mô tả chi tiết</label>
        <textarea id="description" name="description" maxlength="1000" value="<?php echo $this->description;?>"></textarea><br>        
       
        <label class="input-form" for="avatar">Avatar</label>
        <input type="file" id="real-file" name="avatar" hidden="hidden" accept="image/*"/>
        <input id="custom-text" type="text" value="<?php echo $this->avatar;?>">
